...
function PlayerCard({
  ...
  return (
    <div
      ...
      style={{
        backgroundColor: isSelected ? 'rgba(8,145,178,0.07)' : 'transparent',
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-start justify-between gap-2 mb-0.5">
          <p className="text-sm font-semibold truncate leading-tight" style={{ color: '#0C1A2E' }}>
            {player.name}
          </p>
          {/* Status badge */}
          <span
        ...
        {/* Platform */}
        {platform && (
          <p className="text-xs capitalize mb-1" style={{ color: '#334155' }}>
            {platform}
          </p>
        )}
        ...
        {code && (
          <div className="flex items-center gap-1.5">
            <span className="text-xs" style={{ color: '#334155' }}>Code:</span>
            <code className="text-xs font-mono font-bold tracking-widest" style={{ color: '#0891B2' }}>
              {code}
            </code>
            <button
              onClick={(e) => {
        ...
        >
          ...
          <div className="relative flex flex-col sm:flex-row sm:items-start sm:justify-between responsive-hero pb-4 gap-3">
            <div>
              ...
              <h1 className="text-2xl sm:text-3xl font-bold leading-tight mb-1" style={{ color: '#0C1A2E' }}>
                Player Network
              </h1>
        ...
        >
          ...
          <div className="flex-1 relative overflow-hidden flex items-center justify-center" style={{ backgroundColor: '#F0F9FF' }}>
            <div className="text-center px-6">
              <Monitor className="h-12 w-12 mx-auto mb-3 opacity-20" style={{ color: '#94A3B8' }} />
        ...
        >
          ...
          >
            <div className="flex items-center gap-2.5">
              <h2 className="text-sm font-semibold" style={{ color: '#0C1A2E' }}>
                Active Players
              </h2>
              <span
