...
const LABEL_STYLE = { color: 'var(--color-text-secondary)', fontSize: 12, marginBottom: 4, display: 'block' as const }
const SECTION_CARD = {
  ...
  return (
    ...
    >
      <div
        ...
        style={{
          backgroundColor: danger ? 'rgba(220,38,38,0.12)' : 'color-mix(in srgb, var(--color-primary) 10%, transparent)',
        }}
      >
        <Icon
          className="h-4 w-4"
          style={{ color: danger ? '#F87171' : 'var(--color-primary)' }}
        />
      </div>
      <div>
...
function SaveBtn({ onClick, saving }: { onClick: () => void; saving?: boolean }) {
  return (
    <div className="flex justify-end mt-5 pt-4" style={{ borderTop: '1px solid var(--color-border)' }}>
      <button
        onClick={onClick}
        disabled={saving}
        className="px-5 py-2 rounded-lg text-sm font-semibold transition-colors"
        style={{ backgroundColor: 'var(--color-primary)', color: '#FFFFFF', opacity: saving ? 0.6 : 1 }}
      >
    ...
    >
      <span
        ...
        style={{
          ...
          borderRadius: 8, backgroundColor: value ? '#FFFFFF' : 'var(--color-text-muted)',
        }}
      />
    </button>
  )
...
export default function SettingsPage() {
  ...
  return (
    <div className="flex flex-col h-full" style={{ backgroundColor: '#f0f9ff' }}>
      ...
      <div className="page-container pt-4 sm:pt-5">
        ...
        >
          ...
          <div className="relative z-10 responsive-hero">
            <p className="text-xs font-semibold tracking-widest uppercase mb-2" style={{ color: 'var(--color-primary)' }}>
              Settings
            </p>
            <h1 className="text-2xl sm:text-3xl font-bold mb-1" style={{ color: 'var(--color-text-primary)' }}>Account Settings</h1>
      ...
      <div className="md:hidden scroll-x px-3 py-3" style={{ borderBottom: '1px solid var(--color-surface-alt)' }}>
          ...
          {NAV.map(({ key, label, Icon }) => {
            ...
            return (
              <button
                ...
                style={
                  isActive
                    ? { backgroundColor: 'color-mix(in srgb, var(--color-primary) 10%, transparent)', color: 'var(--color-primary)', border: '1px solid color-mix(in srgb, var(--color-primary) 30%, transparent)' }
      ...
      <div className="page-container py-4 flex flex-col md:flex-row gap-4 items-start">
        ...
        <div
          ...
          style={{ width: 160, backgroundColor: '#FFFFFF', border: '1px solid var(--color-border)' }}
        >
          {NAV.map(({ key, label, Icon }) => {
            const isActive = activeTab === key
            return (
                ...
                {pwStep === 'form' ? (
                  <div className="space-y-4">
                    <div>
                      ...
                      <input style={{ ...INPUT_STYLE, color: 'var(--color-text-muted)', cursor: 'default' }} value={email} readOnly />
                    </div>
                    <div>
                      ...
                      <input
                        ...
                        onBlur={(e)  => (e.currentTarget.style.borderColor = 'var(--color-border)')}
                      />
                      <p className="text-xs mt-1.5" style={{ color: 'var(--color-text-secondary)' }}>Must be at least 8 characters</p>
                    </div>
                    <div>
                    ...
                    <div className="flex justify-end pt-4 mt-4" style={{ borderTop: '1px solid var(--color-border)' }}>
                      <button
                        ...
                        style={{ backgroundColor: 'var(--color-primary)', color: '#FFFFFF', opacity: pwSaving ? 0.6 : 1 }}
                      >
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      />
                      <p className="text-xs mt-1.5" style={{ color: 'var(--color-text-secondary)' }}>
                        Check your inbox at <span style={{ color: 'var(--color-primary)' }}>{email}</span>
                      </p>
                    </div>
                    <div className="flex justify-between pt-4 mt-4" style={{ borderTop: '1px solid var(--color-border)' }}>
                      <button
                      ...
                      <button
                        ...
                        style={{ backgroundColor: 'var(--color-primary)', color: '#FFFFFF', opacity: pwSaving || !pwCode ? 0.6 : 1 }}
                      >
              ...
              <div style={SECTION_CARD}>
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm font-medium" style={{ color: 'var(--color-text-primary)' }}>2FA is enabled</p>
                      <p className="text-xs mt-0.5" style={{ color: 'var(--color-text-secondary)' }}>Your account is protected with 2FA</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div style={SECTION_CARD}>
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <h3 className="text-xl font-bold" style={{ color: 'var(--color-text-primary)' }}>Free Plan</h3>
                    <p className="text-sm mt-0.5" style={{ color: 'var(--color-text-secondary)' }}>Perfect for getting started</p>
                  </div>
                  <div className="text-right">
                    <p className="text-3xl font-bold" style={{ color: 'var(--color-primary)' }}>$0</p>
                    <p className="text-xs" style={{ color: 'var(--color-text-secondary)' }}>per month</p>
                  </div>
                </div>
          ...
          {activeTab === 'team' && (
            <>
              <div style={SECTION_CARD}>
                ...
                <div className="flex justify-end mt-5 pt-4" style={{ borderTop: '1px solid var(--color-border)' }}>
                  <button
                    ...
                    style={{ backgroundColor: 'var(--color-primary)', color: '#FFFFFF', opacity: sendInvitationMutation.isPending ? 0.6 : 1 }}
                  >
                    <Mail className="h-4 w-4" />
              ...
              <div style={SECTION_CARD}>
                ...
                {members.length === 0 ? (
                  <p className="text-sm py-4 text-center" style={{ color: 'var(--color-text-secondary)' }}>No members found</p>
                ) : (
                  <div className="space-y-2">
                    {members.map((m: any, i: number) => (
                      ...
                      >
                        <div>
                          <p className="text-sm font-medium" style={{ color: 'var(--color-text-primary)' }}>{m.email || m.cognito_sub}</p>
                          {m.joined_at && (
                ...
                <div style={SECTION_CARD}>
                  ...
                  <div className="space-y-2">
                    {invitations.map((inv: any, i: number) => (
                      ...
                      >
                        <div>
                          <p className="text-sm font-medium" style={{ color: 'var(--color-text-primary)' }}>{inv.email}</p>
                          <p className="text-xs mt-0.5" style={{ color: 'var(--color-text-secondary)' }}>
      ...
      <Dialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
        <DialogContent hideClose className="!p-0 max-w-sm">
          <div style={{ padding: '20px 22px 16px', borderBottom: '1px solid var(--color-border)', display: 'flex', alignItems: 'flex-start', gap: 14 }}>
            ...
            <div>
              <h2 style={{ fontSize: 17, fontWeight: 700, color: 'var(--color-text-primary)', margin: 0 }}>Delete Account</h2>
